...
randGrid :: GameGrid
randGrid = (GameGrid 40 (concat(replicate 16 ['_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', 'r', '_', '_', '_', 'c', 'r', 'r', 'r', 'r', '_', '_', '_', '_', 'b', 'r','_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', '_', '_', '_', '_', 'c', '_', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r', '_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', '_', 'r', '_', '_', 'c', 'r', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r','_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', 'r', '_', '_', '_', 'c', '_', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r', 'r' , 'r', 'r', 'r', 'b'])))
