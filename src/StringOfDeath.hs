...
randGrid :: GameGrid
randGrid = (GameGrid 50 (concat(replicate 25 ['_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', 'r', '_', '_', '_', 'c', 'r', 'r', 'r', 'r', '_', '_', '_', '_', 'b', 'r','_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', '_', '_', '_', '_', 'c', '_', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r', '_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', '_', 'r', '_', '_', 'c', 'r', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r','_', '_', '_', 'g', '_', 'b', 'b', '_', 'y', 'r', '_', '_', '_', 'c', '_', 'r', 'r', 'r', '_', '_', 'c', 'b', 'b', 'r', 'r' , 'r', 'r', 'r', 'b'])))
